          ...
          <section className="panel" id="provider-connections" style={{ marginTop: 12 }}>
            ...
            {currentRole === "agency" && agencyContext.portfolioReady && !agencyContext.loading && !canManageAgencyConnections ? (
              <div className="data-next-step" style={{ marginTop: 8 }}>
                ...
                <span>
                  Доступно: просмотр состояния источников и обновление уже добавленных рекламных аккаунтов. Чтобы подключать платформы, искать аккаунты и управлять авторизацией, попросите владельца или менеджера агентства назначить вам роль «Менеджер».
                </span>
              </div>
            ) : null}
