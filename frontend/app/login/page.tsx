    ...
    <main className="login-shell">
      <section className="login-card">
        ...
        <p className="panel-subtitle">
          Первый вход через Facebook сразу создаст ваш клиентский кабинет — без ожидания подтверждения. Facebook и Google здесь используются только для входа; рекламные кабинеты подключаются позже в разделе «Данные и подключения».
        </p>
